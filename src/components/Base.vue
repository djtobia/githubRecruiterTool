<template>
    <v-content>
        <v-container>
            <v-row>
                <v-col cols="12" md="3" sm="12" xs="12" align="center" justify="center">
                ...
                <v-col cols="12" md="3" sm="12" xs="12" justify="center" align="center">
                    <v-col> Think this tool is useful, or just wanna help a dude out? Feel free to
                        donate!
                    </v-col>
